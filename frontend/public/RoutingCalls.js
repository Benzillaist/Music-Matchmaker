...
async function _addTrack(playlist_id, track_id) {
...
async function _findTrack(song_id) {
...
async function _findArtist(artist_id) {
...
async function _createPlaylist(playlist_name) {
